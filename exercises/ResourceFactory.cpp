...
{ 
    std::shared_ptr<Resource> makeResourceA(char* byte) { return make_shared<ResourceA>(byte); }
    std::shared_ptr<Resource> makeResourceB(char* byte) { return make_shared<ResourceB>(byte); }
};
